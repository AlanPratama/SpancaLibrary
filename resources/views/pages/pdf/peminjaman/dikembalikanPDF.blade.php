...
<body>
    <center>
        <div class="header">
            ...
            <h1>SPANCA LIBRARY - STATUS DIKEMBALIKAN</h1>
        </div>
    </center>
    <p style="font-size: 18px;"><span style="font-weight: 600;">Total Peminjaman: </span>{{ $dikembalikan->count() }}</p>
    </p>
